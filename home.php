...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
  ...
  <section class="section-white">
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6">
          <img src="resources/home_main.jpg" alt="Section 1">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section-navy">
    <div class="container">
      <div class="row align-items-center flex-row-reverse">
        ...
        <div class="col-lg-6">
          <img src="resources/model.jpg" alt="Section 2">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section-white">
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6">
          <img src="resources/model2.jpg" alt="Section 3">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section-navy">
    <div class="container">
      <div class="row align-items-center flex-row-reverse">
        ...
        <div class="col-lg-6">
          <img src="resources/model3.png" alt="Section 4">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section-white">
    <div class="container text-center">
      ...
      <img src="resources/model4.jpg" alt="Section 5" class="img-fluid rounded">
    </div>
  </section>
  ...
  <footer>
    ...
    <div class="d-flex justify-content-between flex-wrap align-items-center">
      <img src="resources/header_logo.png" height="40" alt="Logo">
      <div class="links">
